...
function SteeringPad() {
  ...
  const update = (event: React.PointerEvent<HTMLDivElement>) => {
    ...
    setValue(next)
    // Rapier vehicle steering is opposite to screen-space touch direction.
    // Keep the thumb under the finger, but invert the value sent to physics.
    ...
    <main className="app-shell">
      ...
      <header className="topbar">
        <div>
          ...
          <h1>R2 Detailed Bus Integration</h1>
        </div>
